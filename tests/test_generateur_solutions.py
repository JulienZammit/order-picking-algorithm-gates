...
from src.generateur_solutions import generer_fichier_solution
...
class TestGenerateurSolutions(unittest.TestCase):
    def test_generer_fichier_solution(self):
        ...
        colis1 = Colis(1, 1)  # Colis ID 1, Commande ID 1
        colis1.produits = {1: 2, 2: 1}  # Produit ID 1: qty 2, Produit ID 2: qty 1
        colis2 = Colis(2, 2)  # Colis ID 2, Commande ID 2
        ...
        chemin_fichier = f"data/solutions/{nom_instance}_sol.txt"
